...
import com.example.mediateka.presentation.common.PhotoLoader;
...
public class PosterSliderFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (isBackgroundPoster()){
            ...
            UrlImagePathCreator.Quality defaultQuality = toQuality(sharedPreferences
    ...
    private UrlImagePathCreator.Quality toQuality(String quality){
        return UrlImagePathCreator.Quality.valueOf(UrlImagePathCreator.Quality.class.getSimpleName() + quality);
    }
